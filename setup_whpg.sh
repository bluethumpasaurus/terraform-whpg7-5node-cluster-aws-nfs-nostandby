...
SERVER2_PRIVATE_IP="10.0.2.200" # segment_server_1_private_ip
SERVER3_PRIVATE_IP="10.0.2.201" # segment_server_2_private_ip
SERVER4_PRIVATE_IP="10.0.2.202" # segment_server_3_private_ip
SERVER5_PRIVATE_IP="10.0.2.203" # segment_server_4_private_ip
...
FQDN_S5="ip-$(echo ${SERVER5_PRIVATE_IP} | tr . -).${AWS_REGION}.compute.internal"
...
echo
# Create the seg_hosts file for segment hosts only
...
echo
echo "--- 6. Creating data directories on segment hosts (servers 2, 3, 4 & 5) ---"
echo
...
echo
echo "--- 10. Add trust entries in the Coordinator's pg_hba.conf for the 4 Segment hosts ---"
echo
# Append the new entry to the end of the file
echo "host    all         gpadmin         ${SERVER2_PRIVATE_IP}/32       trust" >> /data/coordinator/gpseg-1/pg_hba.conf
