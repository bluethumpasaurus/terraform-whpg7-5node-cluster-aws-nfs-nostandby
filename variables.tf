...
variable "server_private_ips" {
  ...
  default = [
    ...
    "10.0.2.200", # Server 2 (Segment 1) in private subnet
    "10.0.2.201", # Server 3 (Segment 2) in private subnet
    "10.0.2.202",  # Server 4 (Segment 3) in private subnet
    "10.0.2.203"  # Server 5 (Segment 4) in private subnet
  ]
}
